...
set(MP_CC_DIR "c:/Program Files/Microchip/xc-dsc/v3.20" CACHE PATH "Legacy variable from MPLAB X pointing to the compiler base directory")
set(CMAKE_C_COMPILER "c:/Program Files/Microchip/xc-dsc/v3.20/bin/xc-dsc-gcc.exe" CACHE FILEPATH "Path to the compiler binary")
...
set(CMAKE_ASM_COMPILER "c:/Program Files/Microchip/xc-dsc/v3.20/bin/xc-dsc-gcc.exe" CACHE FILEPATH "Path to the compiler binary.")

# Legacy variable from MPLAB X pointing to the assembler binary.
set(MP_AS ${CMAKE_ASM_COMPILER})

set(MP_LD "c:/Program Files/Microchip/xc-dsc/v3.20/bin/xc-dsc-ld.exe" CACHE FILEPATH "Legacy variable from MPLAB X pointing to the linker binary.")

set(MP_BIN2HEX "c:/Program Files/Microchip/xc-dsc/v3.20/bin/xc-dsc-bin2hex.exe" CACHE FILEPATH "Legacy variable from MPLAB X pointing to the bin2hex binary.")
